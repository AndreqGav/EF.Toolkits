# EF.Toolkits (Archived)

⚠️ **Warning: This repository is no longer maintained and has been split into separate projects.** ⚠️

To improve architecture, simplify maintenance, and enhance usability, the monolithic `EF.Toolkits` package has been split into two independent, purpose-built projects. 
